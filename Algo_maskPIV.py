...
@author: maggie
"""
#Use for RFP or mCherry only!!!!!! you can use for FRET/CFP but results are iffy...
...
for i in range(total_pairs):
   ...
   # CONTROLING CRAZY VECTORS
    ...
    grid_mask = mask_layer[y_indices, x_indices] #| img[y_indices, x_indices] | img2[y_indices, x_indices] | img3[y_indices, x_indices] | img4[y_indices, x_indices])
